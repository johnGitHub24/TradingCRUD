...
/**
 * 【職責】應用就緒後於 Console 印出常用 URL（health／Swagger／H2／前台），方便 IntelliJ 本機啟動。
...
public class StartupInfoLogger implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        String project = env.getProperty("startup.info.project-name", "TradingCRUD");
        ...
        if (h2) {
            ...
            String jdbc = env.getProperty("spring.datasource.url", "jdbc:h2:mem:tradingcrud");
